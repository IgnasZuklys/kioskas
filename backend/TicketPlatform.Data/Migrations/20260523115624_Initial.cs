        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // xmin is a PostgreSQL system column on every row — used as concurrency token, not a real schema column
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // xmin is a PostgreSQL system column — used as concurrency token, not a real schema column
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_TicketCategories_TicketCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_TicketCategoryId",
                table: "OrderItems",
